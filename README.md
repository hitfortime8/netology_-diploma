...
Настроен кастомный дашборд с отображением Load average, использованием памяти и диска - `Use Metrics`.

**Zabbix** доступен с дефолтными учетными данными по адресу:
```text
http://89.169.154.25/zabbix
```
...
<details>
<summary>Snapshots yandex-cloud</summary>
